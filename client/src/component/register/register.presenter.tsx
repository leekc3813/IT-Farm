            ...
            <div className={styles.container}>
              <div className={`${styles.formContainer} ${styles.signInContainer}`}>
                ...
                <div className={styles.form} >
                  ...
                  {props.isLogin? <button onClick={props.onClickLogIn} className={styles.button}>로그인</button> : <button onClick={props.onClickSignUp} className={styles.button}>회원가입</button>}
                </div>
              </div>
