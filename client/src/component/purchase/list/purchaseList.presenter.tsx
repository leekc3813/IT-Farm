        ...
        <div className={styles.body}>
            <div className={styles.wrapper}>
                ...
                <div className={styles.contentContainer}>
                    <Link className={styles.link} href={'/purchase/list/유기농 홍고추 1kg'}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/무농약 홍고추 1kg'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/청홍고추 1kg'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/청홍고추 500g'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                ...
                <div className={styles.contentContainer}>
                    <Link className={styles.link} href={'/purchase/list/유기농 청고추 1kg'}>
                        <div className={styles.contentBox}>
                            <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/무농약 청고추 1kg'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/청고추 500g'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/청고추 1kg'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                ...
                <div className={styles.contentContainer}>
                    <Link className={styles.link} href={'/purchase/list/유기농 건고추 1kg'}>
                        <div className={styles.contentBox}>
                            <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/무농약 건고추 1kg'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/일반 건고추 1kg'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/일반 건고추 500g'}>
                        <div className={styles.contentBox}>
                             <div className={styles.imgBox}>
                ...
                <div className={styles.contentContainer}>
                    <Link className={styles.link} href={'/purchase/list/국산 고추가루 1kg'}>
                        <div className={styles.contentBox}>
                            <div className={styles.imgBox}>
                    ...
                    <Link className={styles.link} href={'/purchase/list/유기농 태양초 고춧가루 1kg'}>
                        <div className={styles.contentBox}>
                            <div className={styles.imgBox}>
